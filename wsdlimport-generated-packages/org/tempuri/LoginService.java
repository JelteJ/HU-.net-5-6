 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8733/Design_Time_Addresses/WinkelService/LoginService/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8733/Design_Time_Addresses/WinkelService/LoginService/?wsdl");
    ...
    public ILoginService getBasicHttpBindingILoginService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ILoginService"), ILoginService.class);
    }
    ...
    public ILoginService getBasicHttpBindingILoginService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ILoginService"), ILoginService.class, features);
    }
