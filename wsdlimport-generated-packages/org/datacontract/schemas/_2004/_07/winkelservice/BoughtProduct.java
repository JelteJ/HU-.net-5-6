...
public class BoughtProduct {
    ...
    @XmlElementRef(name = "Customer", namespace = "http://schemas.datacontract.org/2004/07/WinkelService", type = JAXBElement.class, required = false)
    protected JAXBElement<Customer> customer;
    @XmlElement(name = "CustomerId")
    protected Integer customerId;
    @XmlElement(name = "Id")
    protected Integer id;
    @XmlElementRef(name = "Product", namespace = "http://schemas.datacontract.org/2004/07/WinkelService", type = JAXBElement.class, required = false)
